package org.wycliffeassociates.otter.jvm.app.ui.projectcreator.viewmodel
...
class ProjectCreatorViewModel : ViewModel() {
    ...
    fun goBack() {
        when {
            ...
            collectionHierarchy.size == 1 -> {
                ...
                find<ProjectCreator>().creationWorkspace.navigateBack()
                canGoBack.set(false)
    ...
    fun goNext() {
        getRootSources()
        find<ProjectCreator>().creationWorkspace.dock<SelectCollection>()
