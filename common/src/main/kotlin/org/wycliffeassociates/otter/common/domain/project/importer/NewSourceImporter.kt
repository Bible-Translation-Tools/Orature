    ...
    constructor(
        ...
        private fun importContainer(
            ...
            return Single.create<ImportResult> { emitter ->
                ...
                val versificationTree =
                    VersificationTreeBuilder(versificationRepository)
                        .build(container)
                        ?.apply {
                            for (node in this) {
        ...
        private fun copyToInternalDirectory(
            file: File,
        ...
        private fun copyRecursivelyToInternalDirectory(
            filepath: File,
            destinationDirectory: File,
        ): File {
        ...
        private fun copyFileToInternalDirectory(
            filepath: File,
            destinationDirectory: File,
        ): File {
