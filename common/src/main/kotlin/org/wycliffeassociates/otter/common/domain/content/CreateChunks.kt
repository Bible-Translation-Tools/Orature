...
class CreateChunks
    ...
    constructor(
         ...
         */
        private fun overlayVerses(
            allocatedVerses: List<Content>,
            versesFromText: List<Content>,
        ): List<Content> {
        ...
        private fun writeChunkFile(
            ...
            val file: File =
                workbook.projectFilesAccessor.getChunkFile().apply {
        ...
        private fun findVerseRange(
            verseMarkers: List<VerseRange>,
            chunk: VerseRange,
        ): List<Int> {
