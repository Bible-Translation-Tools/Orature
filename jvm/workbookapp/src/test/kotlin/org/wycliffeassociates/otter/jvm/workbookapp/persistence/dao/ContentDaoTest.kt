...
class ContentDaoTest {
    ...
    fun setup() {
        ...
        defaultEntity = ContentMapper(database.contentTypeDao, database.checkingLevelDao)
    ...
    private fun insertAllSamples() {
        val mapper = ContentMapper(database.contentTypeDao, database.checkingLevelDao)
