...
class TestDirectoryProvider {
    ...
    private fun buildDirectoryProvider(testCase: TestCase) =
        DirectoryProvider(
            "Orature",
    ...
    fun testIfCorrectUserDataDirectoryIsReturnedForEachPlatform() {
        for (testCase in USERDATA_TESTS_TABLE) {
            // get the result
            val fileResult =
                buildDirectoryProvider(testCase)
