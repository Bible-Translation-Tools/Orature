...
class WorkbookTableDemoView : View() {
    val workbookList = observableListOf<ProjectInfo>(
        ProjectInfo(0, "jhn",  "John", "", 0.3, LocalDateTime.now(), true,),
        ProjectInfo(0, "act", "Acts", "", 0.0, LocalDateTime.now(), true,),
        ProjectInfo(0, "gen", "Genesis", "", 0.1, LocalDateTime.now(), true,),
        ProjectInfo(0, "lev", "Leviticus", "", 0.5, LocalDateTime.now(), false,),
        ProjectInfo(0, "psa", "Psalms", "", 0.8, LocalDateTime.now(), false,),
        ProjectInfo(0, "rev", "Revelation", "", 1.0, LocalDateTime.now(), false,),
        ProjectInfo(0, "mrk", "Mark", "", 0.5, LocalDateTime.now(), false,),
        ProjectInfo(0, "mal", "Malachi", "", 1.0, LocalDateTime.now(), false,),
        ProjectInfo(0, "pro", "Proverbs", "", 0.2, LocalDateTime.now(), true,),
        ProjectInfo(0, "col", "Colossians", "", 1.0, LocalDateTime.now(), true,),
    )
