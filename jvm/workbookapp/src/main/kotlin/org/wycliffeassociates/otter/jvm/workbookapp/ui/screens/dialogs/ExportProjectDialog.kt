...
class ExportProjectDialog : OtterDialog() {
    ...
    private val content =
        VBox().apply {
            ...
            hbox {
                ...
                label {
                    textProperty().bind(
                        workbookDescriptorProperty.stringBinding {
            ...
            vbox {
                ...
                borderpane {
                    ...
                    center =
                        exportProjectTableView(chapters, selectedChapters) {
                            tableView = this
                        }
                }
            }
            ...
            hbox {
                ...
                label {
                    addClass("h5")
                    textProperty().bind(
                        estimatedSizeProperty.stringBinding {
    ...
    private val selectionListener =
        SetChangeListener<ChapterDescriptor> {
            updateEstimateSize()
        }
    ...
    private fun updateEstimateSize() {
        val sizeInBytes =
            onEstimateSizeAction.value?.invoke(
                workbookDescriptorProperty.value,
                selectedChapters.map { it.number },
                exportTypeProperty.value,
            ) ?: 0
