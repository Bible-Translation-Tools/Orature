...
class ResourceRepository
    @Inject
    constructor(private val database: AppDatabase) : IResourceRepository {
        ...
        private fun getContentResourceFksByCollection(
            collectionId: Int,
            dsl: DSLContext,
        ): List<Int> {
            return dsl
        ...
        private fun mapToResourceMetadata(entity: ResourceMetadataEntity): ResourceMetadata {
            val languageEntity =
                languageDao.fetchById(entity.languageFk)
