...
class HomePage2 : View() {
    ...
    init {
        ...
        tryImportStylesheet("/controls/css/contributor-info.css")
        ...
        tryImportStylesheet("/controls/css/progress-dialog.css")
        tryImportStylesheet("/controls/css/card-radio-btn.css")
        tryImportStylesheet("/controls/css/snack-bar-notification.css")
