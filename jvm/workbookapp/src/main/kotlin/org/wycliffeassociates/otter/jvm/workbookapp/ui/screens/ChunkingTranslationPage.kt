...
class ChunkingTranslationPage : View() {
    ...
    private val mainFragmentProperty =
        viewModel.selectedStepProperty.objectBinding { step ->
            val fragment =
                when (step) {
    ...
    override val root =
        vbox {
            ...
            borderpane {
                ...
                left =
                    ChunkingStepsDrawer(viewModel.selectedStepProperty).apply {
